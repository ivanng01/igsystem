        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-0">
            ...
            <table class="table-auto w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border px-4 py-2 text-gray-900 text-center">{{ $student->student_id }}</td>
                        <td class="border px-4 py-2 text-gray-900 text-center">{{ $student->student_surname }}</td>
                        <td class="border px-4 py-2 text-gray-900 text-center">{{ $student->student_name }}</td>
                        <td class="border px-4 py-2 text-gray-900 text-center">{{ $student->course_name }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
