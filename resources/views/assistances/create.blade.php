            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3 lg:p-4">
                        ...
                        <form method="POST" action="{{route('students.store')}}" class="max-w-sm mx-auto">
                            ...
                            <div class="mb-3">
                                ...
                                <!-- <input type="number" name="subject" id="subject" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required> -->
                            </div>
