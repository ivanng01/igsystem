            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                <form method="POST" action="{{ route('assistances.store') }}">
                    ...
                    <div class="flex justify-end mt-6">
                        <button type="submit" class="text-white bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Enviar Asistencia</button>
                    </div>
                </form>
            </div>
        </div>
